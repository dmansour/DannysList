...
<table style="margin:0px auto; width:400px" align="center">
  <tr>
    <th width="33%" align="center" scope="row"><h2><center>Register For DannysList!</center></h2></th>
  </tr>
  <tr style="margin: 0">
    <td align="center" valign="top"><p>
    <form action=NewUser name="mainform" method="post">
...
<!-- 		<a class="btn btn-primary btn-lg" style="width:200px" id="about" href="#">About</a> -->
		...
		<span class="input-group-addon">Password:</span>
  		...
  		<input type="submit" class="btn btn-primary btn-default" style="width:100px" id="register" value="Register" ></input>
  		<a class="btn btn-primary btn-default" style="width:100px" id="cancel" href="index.jsp">Cancel</a>
	</div>
	</form>
	</td>
</tr>
